...
const uint8 gamestory_string[12][150] =  
{
  ...
  "Короче, возвращается Инопланентянин на свою родную планенту, а там все захватили Злые Звезды. Везде летают, все ломают. В общем безобразничают.",
  "И теперь Инопланетянину необходимо во что бы то ни стало победить всех Злых Звезд, иначе на его планенте наступит...",
